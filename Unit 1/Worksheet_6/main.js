...
document.write("<table border = 0 cellspacing =2 bgcolor=black >");
for(var j = 1;j<=8;j++){
  document.write("<tr bgcolor=white width ="+parseInt(altura)+" height="+parseInt(altura)+">")
  for(var i =1;i<=8;i++){
    if(j%2==0){
      if(i%2==0){
        document.write("<td bgcolor=black height ="+parseInt(altura)+" width ="+parseInt(altura)+">&nbsp</td>");
      }else{
        document.write("<td height ="+parseInt(altura)+" width ="+parseInt(altura)+">&nbsp</td>");
      }
    }else{
      if(i%2!=0){
        document.write("<td bgcolor=black height ="+parseInt(altura)+" width ="+parseInt(altura)+">&nbsp</td>");
